...
const logo3 =
  "https://cdn1.vectorstock.com/i/thumb-large/94/50/woman-paramedic-help-urgency-wearing-uniform-vector-12669450.jpg";
const logo4 =
  "https://www.fellowshippersonalstatement.com/wp-content/uploads/2014/08/interventional-cardiology-fellowship.png";
const logo5 =
  "https://static.vecteezy.com/system/resources/previews/000/425/149/non_2x/vector-bed-icon.jpg";
const url2 =
  "https://bpb-us-e1.wpmucdn.com/sites.psu.edu/dist/e/136937/files/2016/06/Patient_Provider-300x200.jpg";
const logo6 =
  "https://www.siamdevelopment.com/wp-content/uploads/2022/01/Medical-Device-Registration-in-Thailand.jpg";
const url1 =
  "https://img.freepik.com/free-vector/doctor-consultation-online-smartphone-chat-physician-web-template_74855-9095.jpg?w=360&t=st=1707134364~exp=1707134964~hmac=dd0f585e1cfaf96430b5477a7d1c93950a70dc3c54494a3aa2b45392c2c09922";
const url3 = "https://landaspine.com/site/uploads/2020/08/doctor-3-214x300.png";

const url7 =
  "https://s3.amazonaws.com/freebiesupply/large/2x/facebook-logo-circle-transparent.png";
const url8 =
  "https://th.bing.com/th/id/R.37450e5112961120dcb779170753b237?rik=FxuYj3bobzn%2fJQ&riu=http%3a%2f%2fwww.bykoket.com%2fimages%2fft_googleplus-b.png&ehk=3YR6wCf9cxUoqHytSHdvLMJD6cX9I48psZEP6fUnNpU%3d&risl=&pid=ImgRaw&r=0";
    ...
    <div className={style.home}>
      ...
      <div className={style.body}>
        <div className={style.bodypart1}>
          {/* Create Component for Card  */}

          {Array.from({ length: 4 }).map((data, index) => (
            <InfoCard key={index} />
          ))}

          {/* Make sure to user reusable classes */}
          ...
          <div className={style.head2}>
            <div className={style.header3}>
              <div className={style.subheader1}>
                <div className={style.subtitle4}>
                  Medicare Supplement Advocate
                </div>
                <div className={style.subtitle5}>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga
                  quia architecto id impedit illum nesciunt veniam cupiditate
          ...
          <div className={style.head3}>
            ...
            <div className={style.docimageRef}>
              <div className={style.docName}>
                <img src={url3} alt="url3" className={style.docimage4} />
                <h3>Patrick Cortez</h3>
                <h3 id={style.d1}>Doctor</h3>
                <div className={style.medialink}>
                  <div>
                    <img src={url7} alt="url7" className={style.docimage8} />
                  </div>
                  <div>
                    <img src={url8} alt="url8" className={style.docimage9} />
                  </div>
                  <div>
                    <img src={url9} alt="url9" className={style.docimage10} />
                  </div>
                  <div>
                    <img src={url10} alt="url10" className={style.docimage11} />
                  </div>
                </div>
              </div>
              <div className={style.docName}>
        ...
        <div className={style.bodypart4}>
          ...
          <div className={style.confirmbutton}>
            {" "}
            <button id={style.button1}>Confirm</button>{" "}
          </div>
        </div>
